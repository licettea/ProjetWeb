	...
	<body>
		<div id="page">
			...
			<div id="page-content">
					...
					<h3>Saintvicious's number one tip! Check it out!</h3> 
				<div class="embed-responsive embed-responsive-4by3">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/lWeEWutR97E" frameborder="0" allowfullscreen></iframe>
				</div>
					<h3>Gbay99's way to improve at league!</h3>
				<div class="embed-responsive embed-responsive-4by3">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/HlD7ph041e8" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
