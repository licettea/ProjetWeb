	...
	<body>
		<div id="page">
			...
			<div id="page-content">
					...
					<h3>Your next seance(s) : </h3>
					
					<div id="list-coaching">
						<?php
							if ($table==false)
								echo '</br> <div class="alert alert-warning" role="alert">You don\'t have seances yet, please go to the Reservation section to proceed.</div>';
							else {
								echo "</br>";
								echo $table;
							}
